...
import { focusDataOn, focusOnJustData, focusOnJustRef, optionalForRef } from "./refAndData.optics";
...
describe ( "Optics for ReferenceAnd", () => {
  it ( "should be constructable", () => {
    const refAopt = optionalForRef ( refO, aO )
  ...
  it ( "should allow focusQuery", () => {
    const refBopt = optionalForRef ( refO, bO )
  ...
  it ( "should allow us to focusOnJustData", () => {
    const refBopt = optionalForRef ( refO, cO )
