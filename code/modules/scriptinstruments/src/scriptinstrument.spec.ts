...
describe ( 'validateScriptInstrument', () => {
  it ( 'should validate the fixture script instruments', () => {
    ...
    expect ( validateScriptInstrument ( 'prefix' ) ( varying ( 'win', 'linux' ) ) ).toEqual ( [
      ...
      "  prefix.params is undefined",
      "  prefix.cost is undefined",
      "  prefix.windows.params is undefined",
      "  prefix.windows.cost is undefined",
      "  prefix.linux.params is undefined",
      "  prefix.linux.cost is undefined",
      "or",
      "  prefix.params is undefined",
      "  prefix.cost is undefined",
  ...
  it ( "should report errors", () => {
    ...
    expect ( validateScriptInstrument ( 'prefix' ) ( { windows: 1, linux1: 1 } as any ) ).toEqual ( [
      ...
      "  prefix.staleness is undefined",
      "  prefix.cost is undefined",
      "  prefix.windows does not have description as it is of type number and not an object",
      "  prefix.windows does not have params as it is of type number and not an object",
      "  prefix.windows does not have staleness as it is of type number and not an object",
      "  prefix.windows does not have cost as it is of type number and not an object",
      "  prefix.windows does not have script as it is of type number and not an object",
      "  prefix.windows does not have outputColumns as it is of type number and not an object",
      "  prefix.linux is undefined",
      "or",
      "  prefix.description is undefined",
      "  prefix.params is undefined",
