export const mereology = {
  "environment": {
    "children": {
      ...
      "database": {
        "name": { "description": "The name of the database in this environment" }
      }
    },
    "fields": { "gittag": { "description": "The tag that will be in each service's git repo for the code that is in this environment" } }
  },
  "service": {
    "fields": {
